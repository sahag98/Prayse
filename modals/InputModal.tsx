...
interface InputModalProps {
  addPrayerBottomSheetModalRef: React.RefObject<BottomSheetModal>;
  ...
  prayerTitle: string;
  setPrayerTitle: (title: string) => void;
  prayertoBeEdited: Prayer | null;
  setPrayertoBeEdited: (prayer: Prayer | null) => void;
}
...
const InputModal = ({
  ...
  const handleSubmit = async () => {
    ...
    if (!prayertoBeEdited) {
      ...
      // Close modals immediately for smooth transition
      ...
      if (isFirstPrayer || isMilestonePrayer) {
        // Small delay to ensure modals are closed before showing encouragement
        setTimeout(() => {
