...
export const MerchComponent: React.FC<MerchComponentProps> = ({ theme }) => {
  return (
    <View className="flex-1 dark:bg-dark-secondary bg-dark-accent mb-4 p-[10px] rounded-lg dark:border-[#474747] dark:border-2">
      <View
      ...
      >
        ...
        >
          <Text className="font-inter font-bold text-xl dark:text-white text-light-primary">
            Prayse Merch
          </Text>
          <Text className="font-inter font-normal mb-[10px] text-light-primary dark:text-[#bebebe]">
          ...
          >
            <Text className="text-white dark:text-dark-background font-inter font-bold text-[15px]">
              Shop Now
            </Text>
            <AntDesign
              name="shoppingcart"
