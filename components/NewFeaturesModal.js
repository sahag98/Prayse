          ...
          <View ref={ref}>
            {page === 0 && (
              <View style={{ alignItems: "center", gap: 10 }}>
                ...
                >
                  Check out our merch we just released!
                </Text>
            ...
            {page === 1 && (
              <View style={{ alignItems: "center", gap: 10 }}>
                ...
                <View style={{ gap: 5 }}>
                  ...
                  >
                    - Added notification for new reflections and public prayers.
                  </Text>
                  <Text
                    style={
                      theme == "dark"
                  ...
                  >
                    - Adjusted styling for light mode theme.
                  </Text>
                </View>
                <View
                  style={{
