...
const FeedbackItems = ({ options, actualTheme, theme }: any) => {
  return (
            ...
            <TouchableOpacity
              ...
              className={cn(
                `w-full flex-row items-center ${
                  option.id !== 2 && "border-b"
                }  border-b-light-primary/50 dark:border-b-[#585858] bg-light-secondary dark:bg-dark-secondary p-5 justify-between`
              )}
            >
